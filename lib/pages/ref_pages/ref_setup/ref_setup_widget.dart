...
import '/pages/ref_pages/ref_view/ref_view_widget.dart';
import '/pages/ref_pages/select_fencer/select_fencer_widget.dart';
...
class RefSetupWidget extends StatefulWidget {
  const RefSetupWidget({super.key});

  @override
  State<RefSetupWidget> createState() => _RefSetupWidgetState();
}
